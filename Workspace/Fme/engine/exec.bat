...
IF NOT "%1"=="noecho" echo exec.bat: Testing for perl ...
perl -e "exit 0" 
...
IF NOT "%1"=="noecho" echo exec.bat: Found perl!

IF NOT "%1"=="noecho" echo exec.bat: Changing directory to %~sdp0fermat3\
cd %~sdp0fermat3\

IF NOT "%1"=="noecho" echo exec.bat: Setting the environment variables ...
...
IF NOT "%1"=="noecho" echo exec.bat: Executing WSL file ...
