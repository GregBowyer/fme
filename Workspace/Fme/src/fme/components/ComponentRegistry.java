...
public class ComponentRegistry {
    ...
    public static void disableItemSelectionComponents() {
        ((TreeGUI) guiComponents.get("TreeGUI")).disableComponent();
        ((EditorGUI) guiComponents.get("EditorGUI")).disableComponent();
    }
    ...
    public static void enableItemSelectionComponents() {
        ((TreeGUI) guiComponents.get("TreeGUI")).enableComponent();
        ((EditorGUI) guiComponents.get("EditorGUI")).enableComponent();
    }
}
